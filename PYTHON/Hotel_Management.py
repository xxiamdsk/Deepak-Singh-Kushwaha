...
db = mysql.connector.connect(
    host='localhost', user='root', password='deepak', database='HOTEL_MANAGEMENT')
mycursor = db.cursor()
...
mycursor.execute(
    "create table if not exists Room(Rooms varchar(10),Type varchar(45),Charges int(7),Features varchar(90),Occupancy int(45))")
